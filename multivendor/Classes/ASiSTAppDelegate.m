...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	/*
	// test
	NSString *testPath = [NSString pathForLocalizedFileInAppBundle:@"multivendor" ofType:@"htm"];
	
	NSString *sourceSt = [NSString stringWithContentsOfFile:testPath encoding:NSUTF8StringEncoding error:nil];
